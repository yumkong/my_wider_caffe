...
switch usage
    case {'train'}
        ...
        [dataset.imdb_train, dataset.roidb_train] = imdb_from_widerface(devkit, 'trainval', use_flip, cache_dir);
    case {'test'}
        ...
        [dataset.imdb_test, dataset.roidb_test] = imdb_from_widerface(devkit, 'test', false, cache_dir);
    otherwise
