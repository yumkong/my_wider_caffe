...
%% init  
    ...
    %snapshotfile = 'output\rpn_cachedir\faster_rcnn_WIDERFACE_ZF_stage1_rpn\WIDERFACE_train\final';
...
%% -------------------- Training -------------------- 
    ...
    % matconvnet's blob derivative 
    %load('der_cell.mat');
%     caffe_blob_names = {'proposal_bbox_pred', 'proposal_cls_score', 'conv_proposal1', 'conv5_3', ...
%                         'conv5_2', 'conv5_1', 'conv4_3', 'conv4_2', 'conv4_1', 'conv3_3', ...
%                         'conv3_2', 'conv3_1', 'conv2_2', 'conv2_1', 'conv1_2', 'conv1_1'};
%     mat_blob_indices = {35, 34, 32, 30, 28, 26, 23, 21, 19, 16, 14, 12, 9, 7, 4, 2};
%     caffe_blob_names = {'proposal_bbox_pred', 'proposal_cls_score', 'conv_proposal1', 'conv5_3', ...
%                         'conv5_2', 'conv5_1', 'conv4_3', 'conv4_2', 'conv4_1', 'conv3_3', ...
%                         'conv3_2', 'conv3_1'};
